      ...
      <Container className="py-8">
        <FadeIn className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="text-sm font-semibold tracking-tight text-warm-purple/80">
            Trusted by NZ businesses who want their numbers{" "}
            <span className="text-warm-purple">sorted</span>.
          </div>
          <div className="flex items-center gap-6">
            ...
            <div className="hidden text-xs font-semibold text-warm-purple/60 sm:block">
              No exports • No hassle • No worries
            </div>
          </div>
        </FadeIn>
      </Container>
